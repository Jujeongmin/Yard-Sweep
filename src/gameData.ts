...
export const missionPool: MissionDefinition[] = [
  { id: 'leaf100', label: '낙엽 100개 청소', target: 100, trackKind: 'leaf', reward: { coins: 50, gems: 0 } },
  { id: 'can30', label: '빈 캔 30개 수거', target: 30, trackKind: 'can', reward: { coins: 40, gems: 0 } },
  { id: 'regionClear', label: '마당 100% 청소', target: 1, trackType: 'regionClear', reward: { coins: 60, gems: 2 } },
  { id: 'fastClear5min', label: '5분 안에 지역 완료', target: 1, trackType: 'fastClear', reward: { coins: 0, gems: 5 } },
];
...
export const achievements: Record<AchievementId, AchievementDefinition> = {
  firstClean: { id: 'firstClean', label: '첫 청소 완료', target: 1, reward: { coins: 10, gems: 0 } },
  coins1000: { id: 'coins1000', label: '코인 1,000개 획득', target: 1000, reward: { coins: 100, gems: 0 } },
  allRegions: { id: 'allRegions', label: '모든 지역 해금', target: 1, reward: { coins: 0, gems: 20 } },
  leaf10000: { id: 'leaf10000', label: '낙엽 10,000개 제거', target: 10000, reward: { coins: 0, gems: 30 } },
};
